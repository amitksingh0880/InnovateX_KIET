...
const ProfilePage: React.FC = () => {
    ...
    return (
        <PrivateRoute>
            <div className="flex flex-col lg: w-[1280px] bg-gray-100 dark:text-white dark:bg-gray-900">
              <div className='p-8'>
                {/* Header */}
                ...
                {/* Profile Details */}
                <div className="mt-20">
                    <h3 className="text-4xl font-extrabold text-gray-900">{username}</h3>
                    ...
                    <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700">
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg shadow">
                            ...
                            <p className="mt-1 text-lg">MCA</p>
                        </div>
                        <div className="bg-gray-100 p-4 rounded-lg shadow">
                            <p className="font-semibold">Batch:</p>
                            <p className="mt-1 text-lg">2023-2025</p>
                        </div>
                        <div className="bg-gray-100 p-4 rounded-lg shadow">
                            <p className="font-semibold">College:</p>
                            <p className="mt-1 text-lg">KIET GROUP OF INSTITUTIONS</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-12 text-left">
                        ...
                        {isEditing ? (
                            <div className="mt-6">
                                ...
                                />
                                <button
                                    className="w-52 bg-indigo-600 text-white py-2 rounded-lg shadow hover:bg-indigo-700"
                            ...
                            <button
                                className="w-52 flex justify-center align-middle mt-4 bg-indigo-500 text-white py-2 rounded-lg shadow hover:bg-indigo-600"
